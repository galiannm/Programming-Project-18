// code - Nandana
// This extension of the class enables the display of bar charts within the program.
...
void updateBarChart(BarChart chartToUpdate) {
  ...
  chartToUpdate.updateData(accumulatedData); // Update the bar chart with accumulated data
}
